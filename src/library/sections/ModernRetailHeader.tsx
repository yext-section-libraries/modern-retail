...
const ModernRetailHeaderFields: YextFields<ModernRetailHeaderProps> = {
  variant: {
    label: "Variant",
    type: "select",
    options: [
...
const ModernRetailHeaderComponent: PuckComponent<ModernRetailHeaderProps> = (props) => {
      ...
      >
        ...
        {menuOpen ? (
          <div
            ...
            style={{
              backgroundColor: headerSurfaceStyle?.backgroundColor,
            }}
          >
...
export const ModernRetailHeader: YextComponentConfig<ModernRetailHeaderProps> = {
  label: "Header",
  fields: ModernRetailHeaderFields,
  defaultProps: {
  ...
  render: (props) => (
    <AnalyticsScopeProvider
      name={`ModernRetailHeader${getAnalyticsScopeHash(props.id)}`}
    >
      <ModernRetailHeaderComponent {...props} />
    </AnalyticsScopeProvider>
  ),
};

export const config: SectionConfig = {
  id: "ModernRetailHeader",
  displayName: "Header",
  description: "Header",
